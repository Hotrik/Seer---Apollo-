...
struct board {
  ...
  [[nodiscard]] inline zobrist::hash_type white_non_pawn_hash() const noexcept { return man_.white.hash() ^ man_.white.pawn_hash(); }
  [[nodiscard]] inline zobrist::hash_type black_non_pawn_hash() const noexcept { return man_.black.hash() ^ man_.black.pawn_hash(); }
